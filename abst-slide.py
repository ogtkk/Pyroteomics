...
data = pd.read_csv('abst_data.csv', index_col=0, header=0)
print data

fig, ax1 = plt.subplots()
fig.patch.set_color('white')
b0 = ax1.bar([0.2,1.2,2.2], data.iloc[0,:], width=0.4, color='white', edgecolor='black', hatch='//')
plt.ylim(3,5)
plt.ylabel(data.index[0], fontsize=40)
ax1.yaxis.set_label_coords(-0.18, 0.5)
ax2 = ax1.twinx()
b1 = ax2.bar([0.6,1.6,2.6], data.iloc[1,:], width=0.4, color='black')
...
plt.xlim(0,3.2)
plt.xticks([0.6, 1.6,2.6], data.columns, ha='center', fontsize=32)
plt.show()
plt.clf()
